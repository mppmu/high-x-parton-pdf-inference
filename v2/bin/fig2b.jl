...
l = @layout [
        [a1{0.18w}  b1{0.15w} c1{0.15w} d1{0.15w} e1{0.15w} f1{0.15w}]
        [a2{0.18w} b2{0.15w} c2{0.15w} d2{0.15w} e2{0.15w} f2{0.15w}]
        [a3{0.18w} b3{0.15w} c3{0.15w} d3{0.15w} e3{0.15w} f3{0.15w} ]
        [a4{0.18w} b4{0.15w} c4{0.15w} d4{0.15w} e4{0.15w} f4{0.15w} ]
        [a5{0.18w} b5{0.15w} c5{0.15w} d5{0.15w} e5{0.15w} f5{0.15w}]
        [a6{0.18w} b6{0.15w} c6{0.15w} d6{0.15w} e6{0.15w} f6{0.15w}]
...
plot!(samples_data, (:(K_u), :(K_d)),subplot=6, xlabel="",ylabel=L"K_d",colors=[c1, c2, c3])
plot!(samples_data, :(K_d),subplot=7, xlabel="",ylabel="",colors=[c1, c2, c3])
plot!(legend=false,grid=false,foreground_color_subplot=:white,subplot=8)
plot!(legend=false,grid=false,foreground_color_subplot=:white,subplot=9)
plot!(legend=false,grid=false,foreground_color_subplot=:white,subplot=10)

plot!(samples_data, (:(K_u), :(K_q)),subplot=11, xlabel="",ylabel=L"K_q",colors=[c1, c2, c3])
plot!(samples_data, (:(K_d), :(K_q)),subplot=12, xlabel="",ylabel="",colors=[c1, c2, c3])
plot!(samples_data, :(K_q),subplot=13, xlabel="",ylabel="",colors=[c1, c2, c3])
plot!(legend=false,grid=false,foreground_color_subplot=:white,subplot=14)
plot!(legend=false,grid=false,foreground_color_subplot=:white,subplot=15)

plot!(samples_data, (:(K_u), :(K_g)),subplot=16, xlabel="",ylabel=L"K_g",colors=[c1, c2, c3])
plot!(samples_data, (:(K_d), :(K_g)),subplot=17, xlabel="",ylabel="",colors=[c1, c2, c3])
plot!(samples_data, (:(K_q), :(K_g)),subplot=18, xlabel="",ylabel="",colors=[c1, c2, c3])
plot!(samples_data, :(K_g),subplot=19, xlabel="",ylabel="",colors=[c1, c2, c3])
plot!(legend=false,grid=false,foreground_color_subplot=:white,subplot=20)


plot!(samples_data1, (:(K_u), :(Δ_g)),subplot=21, xlabel=L"K_u",ylabel=L"\Delta_g",colors=[c1, c2, c3])
plot!(samples_data1, (:(K_d), :(Δ_g)),subplot=22, xlabel=L"K_d",ylabel="",colors=[c1, c2, c3])
plot!(samples_data1, (:(K_q), :(Δ_g)),subplot=23, xlabel=L"K_q",ylabel="",colors=[c1, c2, c3])
plot!(samples_data1, (:(K_g), :(Δ_g)),subplot=24, xlabel=L"K_g",ylabel="",colors=[c1, c2, c3])
plot!(samples_data1, :(Δ_g),subplot=25, xlabel=L"\Delta_g",ylabel="",colors=[c1, c2, c3])
...
plot!(p[NNN*(NNN-1)+ 4 ],xticks=(3:1:6,["3","4","5","6"]),bottom_margin=5.0mm)
...
plot!(p[2*NNN+1],yticks=(4:2:9,["4","6","8"]),left_margin=7.0mm)
plot!(p[3*NNN+1],yticks=(2:2:7,["2","4","6"]),left_margin=7.0mm)
...
plot!(Shape([0.00,0.00,0.17,0.17],[0.85,0.95,0.95,0.85]),subplot=NNN,fillcolor=c3)
plot!(Shape([0.00,0.00,0.17,0.17],[0.65,0.75,0.75,0.65]),subplot=NNN,fillcolor=c2)
plot!(Shape([0.00,0.00,0.17,0.17],[0.45,0.55,0.55,0.45]),subplot=NNN,fillcolor=c1)
annotate!(p[NNN],0.69,0.90,text(L"~~\mathrm{Posterior}~99~\%",18))
annotate!(p[NNN],0.69,0.70,text(L"~~\mathrm{Posterior}~95~\%",18))
annotate!(p[NNN],0.69,0.50,text(L"~~\mathrm{Posterior}~68~\%",18))
